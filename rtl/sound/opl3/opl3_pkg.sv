...
#******************************************************************************/
package opl3_pkg;
    // TSConf runs the OPL3 core in its 28 MHz peripheral clock domain.
    localparam CLK_FREQ = 28e6;
    ...
    localparam int CLK_DIV_COUNT = 563; // 49.73357 KHz, +0.036% from the original OPL3
